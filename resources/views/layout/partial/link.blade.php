...
<link href="{!! asset('assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css') !!} " rel="stylesheet"
type="text/css" />
...
<script src="{!! asset('assets/sweetalert2/dist/sweetalert2.min.js') !!}" type="text/javascript"></script>
